...
| features      | Array[Enum] | Optional | An array of features which can be any of: <ul><li>`fares`</li><li>`flex`</li><li>`fares-v2`</li><li>`fares-v1`</li><li>`flex-v1`</li><li>`flex-v2`</li><li>`pathways`</li></ul>|  
